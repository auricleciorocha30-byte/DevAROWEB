...
const FeatureCard = ({ icon: Icon, title, description, isNew }: { icon: any, title: string, description: string, isNew?: boolean }) => (
  <motion.div 
    whileHover={{ y: -5 }}
    className="glass p-6 rounded-2xl flex flex-col gap-4 hover:border-brand-cyan/50 transition-colors relative overflow-hidden"
  >
    {isNew && (
      <div className="absolute top-4 right-[-35px] bg-brand-cyan text-brand-dark px-10 py-1 rotate-45 text-[10px] font-bold uppercase tracking-widest shadow-lg">
        Novo
      </div>
    )}
      ...
      <section id="cliente" className="py-24 px-6 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard 
              icon={Smartphone} 
              title="Menu Digital & PagBank" 
              description="Atendimento local e delivery com pagamento digital integrado via PagBank. Agilidade total no checkout."
              isNew
            />
            <FeatureCard 
              icon={QrCode} 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass p-8 rounded-3xl">
              ...
              <ul className="space-y-4 text-gray-400">
                <li className="flex gap-3"><CheckCircle2 size={18} className="text-brand-cyan shrink-0" /> <span><strong className="text-white">Pagamentos Digitais:</strong> Integração nativa com PagBank para pagamentos online no cardápio.</span></li>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard 
              ...
              description="Emissão simplificada de NF-e e NFC-e integrada via API da FocusNFE diretamente no PDV."
              isNew
            />
            <FeatureCard 
